...
int main() {
	...
	T2 = T;
	//cout << T2 << endl;
	//NodeData* tes = new NodeData("iii");
	//cout << T.getHeight(*tes) << endl;
...
// 343 Binary Search Tree.cpp : Defines the entry point for the console application.
//
...
int main()
{
	...
	NodeData* a = new NodeData("iii");
	NodeData* b = new NodeData("not");
	NodeData* c = new NodeData("eee");
	NodeData* d = new NodeData("ttt");
	NodeData* e = new NodeData("jj");
	NodeData* f = new NodeData("ff");
	NodeData* g = new NodeData("and");
	NodeData* h = new NodeData("m");
	NodeData* i = new NodeData("y");
	NodeData* j = new NodeData("r");
	NodeData* k = new NodeData("z");
	NodeData* l = new NodeData("sssss");
	NodeData* m = new NodeData("pp");
	NodeData* n = new NodeData("ooo");
